...
class InfosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create info" do
    assert_difference('Info.count') do
      post infos_url, params: { info: { behance: @info.behance, desc: @info.desc, email: @info.email, facebook: @info.facebook, instagram: @info.instagram, name: @info.name, tel: @info.tel } }
    end
  ...
  test "should update info" do
    patch info_url(@info), params: { info: { behance: @info.behance, desc: @info.desc, email: @info.email, facebook: @info.facebook, instagram: @info.instagram, name: @info.name, tel: @info.tel } }
