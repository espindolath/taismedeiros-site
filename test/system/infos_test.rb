...
class InfosTest < ApplicationSystemTestCase
  ...
  test "creating a Info" do
    ...
    fill_in "Behance", with: @info.behance
    fill_in "Desc", with: @info.desc
    fill_in "Email", with: @info.email
    fill_in "Facebook", with: @info.facebook
    fill_in "Instagram", with: @info.instagram
    fill_in "Name", with: @info.name
    fill_in "Tel", with: @info.tel
